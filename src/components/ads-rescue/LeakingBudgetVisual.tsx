...
const LEAKS: LeakInfo[] = [
  {
    ...
    name: "Audience Leak",
    icon: Crosshair,
    tag: "Wrong People Reached",
    wasteRange: "20% - 35% of spend",
    symptom: "Getting clicks from outside your service area or from people with zero purchasing intent.",
    rootCause: "Ads are showing to casual searchers and loose audience expansions who will never buy.",
    fix: "Tighten search queries and eliminate non-buyer audience segments.",
  ...
  },
  {
    ...
    name: "Tracking Leak",
    icon: Activity,
    tag: "False Conversion Data",
    wasteRange: "15% - 40% misattribution",
    symptom: "Ad manager reports 50 conversions, but your bank account and CRM only show 12.",
    rootCause: "The ad platform is counting accidental clicks or page reloads as real leads.",
    fix: "Fix tracking tags so the algorithm only optimizes for genuine, paying customers.",
  ...
  },
  {
    ...
    name: "Messaging Leak",
    icon: Sparkles,
    tag: "Curiosity vs Buyer Intent",
    wasteRange: "25% - 45% click burn",
    symptom: "People click on your ad, but leave immediately once they see what you actually sell.",
    rootCause: "The ad creative doesn't clearly explain the offer, price, or who it's for.",
    fix: "Rewrite ad hooks to attract actual buyers and filter out time-wasters.",
  ...
  },
  {
    ...
    icon: Filter,
    tag: "Mobile Page Drop-Off",
    wasteRange: "30% - 50% drop-off",
    symptom: "Interested visitors click the ad but drop off without submitting their details.",
    rootCause: "Slow mobile loading, too many form questions, or an unclear next step.",
    fix: "Streamline the mobile page to make inquiring or buying fast and frictionless.",
