...
const EXAMPLE_PILLARS = [
  { name: "ATTRACT", label: "Reaching the right people", score: 6.0, dots: 6, max: 10, status: "Moderate", color: "text-accent-yellow" },
  { name: "CONVINCE", label: "Message & offer strength", score: 4.0, dots: 4, max: 10, status: "Needs Work", color: "text-orange-400" },
  { name: "CONVERT", label: "Landing page & lead flow", score: 5.0, dots: 5, max: 10, status: "Friction Found", color: "text-orange-400" },
  { name: "TRACK", label: "Conversion data & tracking", score: 3.0, dots: 3, max: 10, status: "Money Leaking", color: "text-accent-red" },
  { name: "SCALE", label: "Budget & growth readiness", score: 7.0, dots: 7, max: 10, status: "Capable", color: "text-green-400" },
];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-12 md:mb-16">
          ...
          <p className="font-sans text-base sm:text-lg text-foreground/80 font-medium max-w-xl mx-auto">
            Not a generic audit. Not vague advice. You receive your:
          </p>
        ...
        <div className="max-w-4xl mx-auto bg-[#141414] border-4 border-foreground/30 p-6 sm:p-10 shadow-2xl relative">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-foreground/15 pb-4 mb-6">
            ...
            <span className="text-[11px] font-mono text-foreground/50 border border-foreground/15 px-2.5 py-0.5">
              Client Spend: ₹60,000/mo · Meta & Google Ads
            </span>
          </div>
          ...
          <div className="bg-[#1C1C1C] border-2 border-accent-yellow p-4 sm:p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-[6px_6px_0_0_#FFE600]">
            <div className="space-y-1 text-center md:text-left">
              ...
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-orange-500/20 text-orange-400 border border-orange-500/40 text-xs font-mono font-black uppercase">
                <span>🟠 Money May Be Leaking</span>
              </div>
            </div>
            ...
            <div className="space-y-2 max-w-md text-xs font-mono text-foreground/85 text-center md:text-left">
              ...
              <span className="text-[11px] text-accent-yellow block font-bold">
                Directive: Fix conversion tracking and mobile funnel before increasing ad budget.
              </span>
            </div>
          </div>
